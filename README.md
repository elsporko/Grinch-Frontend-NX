...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/dwaD7pude5)
...
```sh
npx nx serve Grinch-Frontend-NX
```

To create a production bundle:

```sh
npx nx build Grinch-Frontend-NX
```

To see all available targets to run for a project, run:

```sh
npx nx show project Grinch-Frontend-NX
```
